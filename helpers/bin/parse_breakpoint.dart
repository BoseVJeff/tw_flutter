...
void main(List<String> args) {
  ...
  File outFile = File("lib/src/tailwind_breakpoint.dart");
  ...
  BreakpointVisitor visitor = BreakpointVisitor();
  tree.visit(visitor);
  ...
  Class radiusClass = Class((cb) {
    cb.name = "TwBreakpoints";
    cb.abstract = true;
    cb.docs.add("/// All width breakpoints defined in Tailwind CSS");
