...
import 'package:helpers/text_shadow_visitor.dart';
...
void main(List<String> args) {
  ...
  File outFile = File("lib/src/tailwind_shadows_text.dart");
  ...
  TextShadowVisitor visitor = TextShadowVisitor();
  ...
  Class shadowClass = Class((cb) {
    cb.name = "TwTextShadow";
    cb.abstract = true;
    cb.docs.add("/// All text shadows as defined in Tailwind");
